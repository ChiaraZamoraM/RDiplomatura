...
## Paso 6: Guardamos los factores como nuevas variables
...
También podemos normalizar los datos para verlo en una escala más amigable:

```{r}
#install.packages("BBmisc")
library(BBmisc)
data$factor1_normalizado = normalize(data$factor1, 
                                        method = "range", 
                                        margin=2, # by column
                                        range = c(0, 100))
summary(data$factor1_normalizado)
hist(data$factor1_normalizado)
```
